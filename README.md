...
- **Persistent Configuration**: Automatically saves your settings (folder history, filter rules, window size) and per‑path SSH credentials—without storing passwords—to a `g_synchro.json` file for convenience.
